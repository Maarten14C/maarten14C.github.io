...
class BaconMov: public BaconFix {
       ...
       public:
	         BaconMov( Dets *detsdets, int KK, int HH, double **hiatus_pars, double aa, double bb,
				double MMinYr, double MMaxYr, double th0, double thp0, double cc0, double cm, int uuseT, unsigned long int seed): 
				BaconFix( detsdets, KK, HH, hiatus_pars, aa, bb, MMinYr, MMaxYr, th0, thp0, cc0, cm, uuseT, seed, KK-1) {
			...
			double eval(double *x, int prime) {
				...
				//do the standard evaluation as with fixed c's
				//This time, the DERIVED CLASS version of c(k) is used (thus the correct version)
