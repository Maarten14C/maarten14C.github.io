...
The presentation slides of this session can be downloaded from [here](./2b_agemodels_practical.pptx).
...
You can load a previous, existing run without having to run it again (assuming here that depths haven't changed). First load it and then draw the age-model plot to get all the data in memory:
