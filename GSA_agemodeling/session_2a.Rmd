...
This page contains the R code that will be ran in the second session of the GSA Short Course on age-modeling. First we'll cover the theory (part 2a), then the practicalities of running rbacon (part 2b).

The presentation slides of this session can be downloaded from these links: [.odp](./2a_agemodels_practical.odp) or [.pptx](./2a_agemodels_practical.pptx).
