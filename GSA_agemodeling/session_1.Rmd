...
###session 1 part 1
[video on youtube](https://youtu.be/prk2Bgy_Dk4)<br>
[transcript as .txt](./session1/session_1_part1.txt)<br>
[transcript as .vtt](./session1/session_1_part1.vtt)<br>

###session 1 part 2
[video on youtube](https://youtu.be/vHGLiJdMOSU)<br>
[transcript as .txt](./session1/session_1_part2.txt)<br>
[transcript as .vtt](./session1/session_1_part2.vtt)<br>
