...
The streamed sessions are here (in two parts - before and after cat intrusion):  
  -[session 1 part 1_transcript1](./session1/session_1_part1.txt)  
  -[session 1 part 1_audio](./session1/session_1_part1.m4a)  
  -[session 1 part 1_video](./session1/session_1_part1.mp4)  
  -[session1 part 1_transcript2](./session1/session_1_part1.vtt)  
  -[session 1 part 2_transcript1](./session1/session_1_part2.txt)  
  -[session 1 part 2_audio](./session1/session_1_part2.m4a)  
  -[session 1 part 2_video](./session1/session_1_part2.mp4)  
  -[session1 part 2_transcript2](./session1/session_1_part2.vtt)  
