...
[transcript as .txt](./session1/session_1_part1.txt){target="_blank"}<br>
[transcript as .vtt](./session1/session_1_part1.vtt){target="_blank"}<br>

*session 1 part 2*<br>
[video on youtube](https://youtu.be/vHGLiJdMOSU){target="_blank"}<br>
[transcript as .txt](./session1/session_1_part2.txt){target="_blank"}<br>
[transcript as .vtt](./session1/session_1_part2.vtt){target="_blank"}<br>
