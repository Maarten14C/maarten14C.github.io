...
The presentation slides of this session can be downloaded from these links: [odp](./1-radiocarbon.odp) [odp](./1-radiocarbon.pptx). They are in the open-source .odp format, which should open fine in MS-Powerpoint.
